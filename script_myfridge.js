...
function add_meat(){
  ...
  window.open("add_popup_meat.html","add_popup","width=430,height=120,left=400,top=200");
}
function add_vegetable(){
  document.getElementById("kind").value="vegetable";
  window.open("add_popup_vegetable.html","add_popup","width=400,height=120,left=400,top=200");
}
function add_eggs(){
  document.getElementById("kind").value="eggs";
  window.open("add_popup_eggs.html","add_popup","width=400,height=120,left=400,top=200");
}
function add_fish(){
  document.getElementById("kind").value="fish";
  window.open("add_popup_fish.html","add_popup","width=400,height=120,left=400,top=200");
}

//삭제함수들
function delete_chicken(){
  document.getElementById("name").value="chicken";
  window.open("delete_popup.html","delete_popup","width=200,height=100,left=400,top=200");
}
